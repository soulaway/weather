...
public class IntegrationTest {
    ...
    public void testAirportPost() {
        Response response = client
        		.target("http://localhost:8282/collect/airport/BOS/20/30")
    ...
    public void testUpdateWeather(){
        Response response = client
        		.target("http://localhost:8282/collect/weather/BOS/WIND")
        		.request().post(Entity.json(new WeatherPoint("WIND").withFirst(10).withSecond(40)));
        Assert.assertEquals(200, response.getStatus());    	
    }
